...
data_name = DataSource.data_Fangchao_fruitfly_20250731
...
def tissue_mid_name_list_dict_constructor(result_process=False, **kwargs):
    ...
    mid_name_list_in_one_tissue = [
        ...
        [
            'citrate', 'glutamate', 'glutamine', 'succinate', 'fumarate',
            'malate', 'aspartate', ],
    ]

    if model_name == ModelList.complete_model_whole_body:
        tissue = keyword.whole_body
    elif model_name == ModelList.complete_model_gut:
        tissue = keyword.gut
    else:
        raise ValueError()
...
def tissue_flux_name_list_dict_constructor():
    if model_name == ModelList.complete_model_whole_body:
        tissue = keyword.whole_body
    elif model_name == ModelList.complete_model_gut:
        tissue = keyword.gut
