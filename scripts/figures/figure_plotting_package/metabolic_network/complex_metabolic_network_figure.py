...
class NormalAndExchangeTwinNetwork(CompositeFigure):
    ...
    def __init__(
        ...
        figure_title_config_dict = default_parameter_extract(
            metabolic_network_config_dict, ParameterName.figure_title_config_dict, {}, pop=True)
        ...
        if figure_title:
            figure_title_string_dict = default_parameter_extract(
                metabolic_network_config_dict, ParameterName.figure_title, {}, pop=True)
            title_center_y = network_top + self.title_height / 2
            exchange_network_center_y = default_parameter_extract(
                figure_title_config_dict, ParameterName.y, title_center_y, pop=True)
            normal_network_text_loc = Vector(normal_network_center_x, title_center_y)
            exchange_network_text_loc = Vector(exchange_network_center_x, exchange_network_center_y)
            normal_network_title_obj = TextBox(**{
                **network_title_config_dict,
                ParameterName.string: default_parameter_extract(
                    figure_title_string_dict, ParameterName.normal_network,
                    MajorExchangeTitleString.major_pathway, pop=True),
            ...
            exchange_network_title_obj = TextBox(**{
                **network_title_config_dict,
                ParameterName.string: default_parameter_extract(
                    figure_title_string_dict, ParameterName.exchange_network,
                    MajorExchangeTitleString.exchange_flux, pop=True),
