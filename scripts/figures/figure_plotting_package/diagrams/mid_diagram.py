...
class MIDDiagram(CompositeFigure):
    ...
    def __init__(
            self, data_vector: np.ndarray, color_name=ParameterName.blue, text=True,
        ...
        if text:
            text_list = [TextBox(**text_param_dict) for text_param_dict in text_param_dict_list]
            mid_diagram_dict[ParameterName.text] = {text_obj.name: text_obj for text_obj in text_list}
        super().__init__(
