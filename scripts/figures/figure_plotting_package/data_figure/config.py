...
def net_flux_x_axis_labels_generator(flux_id_list, group_id_name_dict=None, with_glns_m=False):
    # group_id_name_dict = {
    #     'glycolysis': 'Glycolysis',
    #     'ser_gly': 'Ser-Gly',
    #     'tca': 'TCA cycle',
    ...
    if group_id_name_dict is None:
        group_id_name_dict = default_group_id_name_dict
